...
SCHEMA='qkf-original-corpus-certificate-v8-actions'
...
def verify(name,cert):
 ...
 counts=dict(states=0,transitions=0,components=len(expected),native_lemmas=0,native_symbolic_steps=0,rewrites=0,action_rewrites=0,action_tail_steps=0)
