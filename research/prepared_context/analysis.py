...
def analyze(root):
    ...
    return dict(schema='qkf-prepared-context-cost-summary-v1', shard=shard, cases=len(reg['cases']),
                ...
                F1='open', algorithms_changed=False, preparation_changed=True, direct_export=False)
