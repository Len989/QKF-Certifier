...
from research.ground_query.prototype.terms import Term
from research.ground_query.prototype.visibility_cc import AxiomReason
from research.ground_query.prototype.visibility_cc_fast import IncrementalVisibilityCC
from research.ground_query.prototype.certificates import CertifiedProofStore


def search(request, horizon=None):
    inp = input_of(request)
