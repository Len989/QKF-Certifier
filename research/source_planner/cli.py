"""Experimental consumer-driven planning CLI; user supplies a goal and budget."""
import argparse
import json
...
def main(argv=None):
    ...
    p.add_argument('--route', choices=('planner', 'ordinary', 'eager'), default='planner')
    ...
    try:
        ...
        if args.command == 'prove':
            ...
            result = check(source, request, load_json(args.proof))
