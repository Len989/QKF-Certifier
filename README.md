...
CI is configured for Linux/Python 3.10–3.14 and Python 3.12 on Windows/macOS.
Local release validation records the environment actually executed; adding a
workflow does not mean GitHub CI has already run.
